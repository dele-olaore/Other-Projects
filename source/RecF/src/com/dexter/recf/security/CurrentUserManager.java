...
public class CurrentUserManager
{
    ...
    public String dashboard()
    {
    	...
    	if(currentUser.getRole().getName().equalsIgnoreCase("Candidate"))
    		ret = "/WEB-INF/candidate/candidate-dashboard.xhtml";
    	else if(currentUser.getRole().getName().equalsIgnoreCase("Administrator"))
    		ret = "/WEB-INF/administrator/admin-dashboard.xhtml";
